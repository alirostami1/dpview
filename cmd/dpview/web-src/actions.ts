...
export function applySettings(
    ...
    state.previewTheme = previewThemeSchema.safeParse(data.settings.preview_theme).success
...
export function setPreviewThemePreference(state: State, previewTheme: PreviewTheme): void {
